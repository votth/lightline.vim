...
" Author: itchyny
" License: MIT License
" Last Change: 2023/06/22 14:57:46.
"
" Customized for/by votth
" =============================================================================
...
let s:_lightline = {
    ...
    \   'mode_map': {
    \       'n': 'NOR', 'i': 'INS', 'R': 'RPL', 'v': 'VSL', 'V': 'V-L', "\<C-v>": 'V-B',
    \       'c': 'CMD', 's': 'SEL', 'S': 'S-L', "\<C-s>": 'S-B', 't': 'CLI'
    \   },
    \   '_mode_': {
